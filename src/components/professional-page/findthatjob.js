              ...
              <div className="flex flex-row flex-wrap gap-[20px] mt-[7px]  text-[#616161]">
                ...
                <div>
                  ...
                  <div className="flex flex-row items-center max-[700px]:justify-center">
                    <button
                      className={`bg-white border-solid border border-[#F48FB1] rounded-[8px] px-[4px] mr-[15px] h-[36px] ${
                        isAscendingClicked && sortAscending
                          ? "bg-[#F08FB0] text-white"
                          : ""
                      }`}
                    ...
                    <button
                      className={`bg-white border-solid border border-[#F48FB1] rounded-[8px] px-[4px] h-[36px] ${
                        isDescendingClicked && sortDescending
                          ? "bg-[#F08FB0] text-white"
                          : ""
                      }`}
