...
const Headers = () => {
  return (
    <div className="flex flex-col flex-warp items-center px-[50px] min-[768px]:px-[120px] bg-white-secondary ">
      <h2 className="mt-[2rem] text-center">The place where</h2>
      <h2 className="mb-[2rem] text-center">
        you get
        <span
      ...
      <h5 className="w-[100%] min-[768px]:w-[50%] text-center">
      ...
      <button className="uppercase mt-[2rem] mb-[2.063rem] w-[16.5rem] h-[3.5rem] rounded-[16px] bg-pink-primary text-white-primary tracking-[0.078rem] ">
