...
const Headers = () => {
  return (
    <div className=" flex flex-wrap flex-col justify-start mt-8 items-center">
      <h1 style={{ fontFamily: 'Montserrat' }} className="font-sans font-light text-6xl mt-2">The place where</h1>
      ...
      <p style={{ fontFamily: 'Montserrat' }} className='w-128 mt-8 whitespace-wrap font-sans font-light text-2xl text-center text-black'>With our Machine Learning algorithm you will get that job
